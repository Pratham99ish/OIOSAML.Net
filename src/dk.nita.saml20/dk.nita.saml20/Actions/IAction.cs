...
namespace Identity.Saml
{
    ...
    public interface IAction
    {
        ...
        void LoginAction(Saml20AbstractEndpointHandler handler, HttpContext context, Saml20Assertion assertion);
        ...
        void LogoutAction(Saml20AbstractEndpointHandler handler, HttpContext context, bool IdPInitiated);
        ...
        void SoapLogoutAction(Saml20AbstractEndpointHandler handler, HttpContext context, string userId);
